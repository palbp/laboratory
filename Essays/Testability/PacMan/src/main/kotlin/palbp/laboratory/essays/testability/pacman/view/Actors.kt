...
/**
 * The information needed to select a sprite on the actor's sprite sheet (see resources/sprites/actors.png)
 */
data class SpriteInfo(val sheetRow: Int, val sheetColumn: Int)

/**
 * Clears the area occupied by the actor on the canvas.
 */
...
/**
 * Draws the actor sprite specified by its coordinates on the sprite sheet (see resources/sprites/actors.png) at the given
 * position on the arena.
 *
 * @param canvas            the canvas where to draw
 * @param spriteAt          the coordinates of the sprite on the sprite sheet
